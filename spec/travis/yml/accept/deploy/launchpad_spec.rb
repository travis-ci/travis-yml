describe Travis::Yml, 'launchpad' do
  ...
  describe 'slug, oauth_token, and oauth_token_secret' do
    describe 'given strs' do
      ...
      it { should have_msg [:alert, :'deploy.oauth_token', :secure, type: :str] }
      it { should have_msg [:alert, :'deploy.oauth_token_secret', :secure, type: :str] }
    end
  ...
  describe 'missing slug', defaults: true do
    ...
    it { should serialize_to **defaults, deploy: [provider: 'launchpad', oauth_token: 'str', oauth_token_secret: 'str'] }
  ...
  describe 'missing oauth_token', defaults: true do
    ...
    it { should serialize_to **defaults, deploy: [provider: 'launchpad', slug: 'str', oauth_token_secret: 'str'] }
  ...
  describe 'missing oauth_token_secret', defaults: true do
    ...
    it { should serialize_to **defaults, deploy: [provider: 'launchpad', slug: 'str', oauth_token: 'str'] }
    it { should_not have_msg [:error, :deploy, :required, key: 'slug', provider: 'launchpad'] }
