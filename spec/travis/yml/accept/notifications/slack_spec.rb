describe Travis::Yml do
  accept 'notifications: slack' do
    ...
    describe 'given a str' do
      ...
      it { should have_msg [:alert, :'notifications.slack.rooms', :secure, type: :str] }
    end
    ...
    describe 'given a seq of strs' do
      ...
      it { should serialize_to notifications: { slack: [{ rooms: ['foo'] }, { rooms: ['bar'] }] } }
      it { should have_msg [:alert, :'notifications.slack.rooms', :secure, type: :str] }
    end
      ...
      describe "inherits shared #{status}" do
        %w(always never change).each do |value|
          describe 'given %p' % value do
            ...
            it { should serialize_to notifications: { slack: [rooms: [secure: secure], status => value] } }
            it { should_not have_msg }
          end
        end
      end
