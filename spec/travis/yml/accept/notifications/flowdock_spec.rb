describe Travis::Yml do
  accept 'notifications: flowdock' do
    ...
    describe 'given a str' do
      ...
      it { should have_msg [:alert, :'notifications.flowdock.api_token', :secure, type: :str] }
    end
    ...
    describe 'given a seq of strs' do
      ...
      it { should serialize_to notifications: { flowdock: [{ api_token: 'one' }, { api_token: 'two' }] } }
      it { should have_msg [:alert, :'notifications.flowdock.api_token', :secure, type: :str] }
    end
