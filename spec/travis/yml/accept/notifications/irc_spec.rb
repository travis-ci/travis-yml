  ...
  accept 'notifications: irc' do
    ...
    describe 'channel_key' do
      describe 'given a hash with a string' do
        ...
        it { should have_msg [:alert, :'notifications.irc.channel_key', :secure, type: :str] }
      end
    ...
    describe 'password' do
      describe 'given a hash with a string' do
        ...
        it { should have_msg [:alert, :'notifications.irc.password', :secure, type: :str] }
      end
    ...
    describe 'nickserv_password' do
      describe 'given a hash with a string' do
        ...
        it { should have_msg [:alert, :'notifications.irc.nickserv_password', :secure, type: :str] }
      end
