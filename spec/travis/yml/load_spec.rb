describe Travis::Yml::Load do
  ...
  describe 'given an array of Parts' do
    let(:parts) do
      [
        Travis::Yml::Part.new(api, 'api.yml', nil),
        Travis::Yml::Part.new(travis_yml, '.travis.yml', mode),
        Travis::Yml::Part.new(import, 'import.yml', mode)
      ]
    end
