describe Travis::Yml::Configs do
  ...
  before { stub_repo(1, 'travis-ci/travis-yml', token: 'user-token') } # authorization
  before { stub_repo(2, 'travis-ci/other', internal: true, body: { id: 2, github_id: 2, vcs_id: 2, private: private, default_branch: 'default', config_imports: true, private_key: PRIVATE_KEYS[:two] }) }
  before { stub_repo(3, 'other/other', internal: true, body: { id: 3, github_id: 3, vcs_id: 3, private: private, default_branch: 'default', config_imports: true, private_key: PRIVATE_KEYS[:two] }) }
