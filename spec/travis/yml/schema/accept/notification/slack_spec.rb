describe Travis::Yml::Schema, 'accept deploy', slow: true do
  ...
  describe 'slack' do
    ...
    describe 'on_start' do
      it { should validate notifications: { slack: { on_start: 'always' } } }
      it { should_not validate notifications: { slack: { on_start: 1 } } }
      it { should_not validate notifications: { slack: { on_start: true } } }
    end
