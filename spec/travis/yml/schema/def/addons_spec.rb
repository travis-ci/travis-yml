describe Travis::Yml::Schema::Def::Addons do
  ...
  it { should include hostname: { type: :string, summary: instance_of(String) } }
  it { should include hosts: { '$ref': '#/definitions/type/strs', summary: instance_of(String) } }
  ...
  it { should include firefox: { anyOf: [{ type: :number }, { type: :string }], example: '68.0b1', summary: instance_of(String) } }
  it { should include mariadb: { type: :string, summary: instance_of(String) } }
  it { should include postgresql: { type: :string, aliases: [:postgres], summary: instance_of(String) } }
  it { should include rethinkdb: { type: :string, summary: instance_of(String) } }
  it { should include ssh_known_hosts: { '$ref': '#/definitions/type/secures', strict: false, summary: instance_of(String), see: instance_of(Hash) } }
end
